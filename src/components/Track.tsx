  ...
  return (
    <Box
      ...
      sx={{
        ...
        padding: '0.5rem',
        '&:hover': !isDragging
          ? { opacity: 0.8, bgcolor: 'primary.hover' }
          : null,
      }}
    ...
    >
      <Box
        component="img"
        sx={{ maxHeight: '100%', width: 'auto', cursor: 'pointer' }}
      ...
      <Box
        ...
        sx={{
          ...
          minWidth: 0,
          alignItems: 'center',
          '& .MuiTypography-root': { fontSize: '0.6rem' },
        }}
      >
        <Box sx={{ width: '40%' }}>
          <Typography
            ...
            sx={{
              ...
              color: queueIndex == ind ? '#1DB954' : null,
              height: '50%',
        ...
        >
          ...
          <Typography color="primary.contrastText">
            {timeConversion(trackInfo.duration_ms)}
          </Typography>
        </Box>
        <Box
